...
public class DBEx1 {
	...
	public static int insertMember(Connection con, String id, String pw) throws SQLException {
		// Statement : 고정된 쿼리를 이용 : select * from member where me_id = 'abc123'
		/*
		 * String sql = "insert into member(me_id, me_pw) values('asdasd1', 'asdasd1')";
		 * Statement stmt = null; stmt = con.createStatement(); stmt.execute(sql);
		 */

		// PreparedStatement : 가변 쿼리를 이용 : select * from member where me_id = ?
