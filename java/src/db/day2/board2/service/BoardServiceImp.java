...
public class BoardServiceImp implements BoardService {
	...
	@Override
	public ArrayList<BoardVO> printBoard(String id) {
		return boardDao.printBoard(id);
	}

	@Override
	public boolean updateBoard(int num, String title) {
		if(boardDao.updateBoard(num, title) != 0) {
			session.commit();
			return true;
		}
		return false;
	...
	@Override
	public ArrayList<BoardVO> printBoardList() {
		return boardDao.printBoardList();
	}
}
