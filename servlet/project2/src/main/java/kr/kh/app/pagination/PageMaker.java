...
public class PageMaker {
	...
	private int displayPageNum;	//보여주는 최대 페이지 개수
	...
	public void calculate() {
		...
		//현재 페이지를 이용하여 최대 가능한 마지막 페이지를 계산
		//cri.getPage()/(double)displayPageNum => 1/5.0 => 0.2, cell(0.2) => 1
		...
		//마지막 페이지네이션이면 : laseEndPage와 endPage가 같으면 다음버튼 비활성화
